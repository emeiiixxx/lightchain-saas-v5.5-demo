...
export function PromptLibrary({phase,entries,onStore,onNotify:notify,onClose}:{phase:'enter'|'exit';entries:Entry[];onStore:(e:Entry[])=>Promise<PromptStoreResult>;onNotify:(message:string)=>void;onClose:()=>void}){
